...
PICS = (environ.get('PICS', 'https://files.catbox.moe/x1xa53.jpg')).split() # Bot Start Picture
...
SHORTLINK_API = environ.get("SHORTLINK_API", "cb6243bee96a21ea399e214f1484a7de4652edc9") # shortlink api
